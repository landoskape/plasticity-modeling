...
class Timer:
    ...
    def __init__(
        self, name: str | None = None, precision: int = 4, timer_method: str = "perf_counter", profile: bool = False
    ):
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if self.start_time is None:
            raise RuntimeError(
                "Timer was not started: this should never happen, contact the developer on GitHub Issues!"
            )
