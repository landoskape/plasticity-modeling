...
iaf.apicalPotValue = options.plasticityRate(1) * iaf.maxApicalWeight;
iaf.apicalDepValue = options.plasticityRate(1) * options.apicalDepression * iaf.maxApicalWeight;
